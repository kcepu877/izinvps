...
require _DIR_('users-blacklist/action');
                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title" title="Click to Add" onclick="modal('New Blacklist','<?= base_url('users-blacklist/add') ?>','','lg')"><i class="fas fa-plus-circle mr-2"></i> User Blacklist </h4>
                           </div>
                        </div>
...
?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="javascript:;" onclick="modal('Detail Blacklist','<?= base_url('users-blacklist/detail?q='.base64_encode($row_query['username'])) ?>','','md')" class="btn btn-sm btn-primary">
                                                <i class="fas fa-list" title="Detail Blacklist"></i>
                                            </a>
                                            <a href="javascript:;" onclick="modal('Delete Blacklist','<?= base_url('users-blacklist/delete?q='.base64_encode($row_query['username'])) ?>','','md')" class="btn btn-sm btn-warning text-white">
