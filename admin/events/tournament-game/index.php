                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title" title="Click to Add" onclick="modal('Publish Event','<?= base_url('events/tournament-game/add_publish') ?>','','lg')"><i class="fas fa-plus-circle mr-2"></i> Publish Event </h4>
                           </div>
                        </div>
...
?>
                                    <tr>
                                        <form method="POST" class="form-inline" role="form">
                                            ...
                                            <td align="center">
                                                <a href="javascript:;" onclick="modal('Edit Event','<?= base_url('events/tournament-game/edit_published?id='.$row_query['id']) ?>','','md')" class="btn btn-sm btn-warning text-white">
