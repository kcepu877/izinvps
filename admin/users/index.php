                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title" title="Click to Add" onclick="modal('New Data','<?= base_url('users/add') ?>','','lg')"><i class="fas fa-plus-circle mr-2"></i> User List </h4>
                           </div>
                        </div>
...
?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="javascript:;" onclick="modal('Detail Pengguna','<?= base_url('users/detail?q='.base64_encode($row_query['id'])) ?>','','md')" class="btn btn-sm btn-primary">
                                                <i class="fas fa-list" title="Detail Pengguna"></i>
                                            </a>
                                            <a href="javascript:;" onclick="modal('Edit Pengguna','<?= base_url('users/edit?q='.base64_encode($row_query['id'])) ?>','','md')" class="btn btn-sm btn-warning text-white">
